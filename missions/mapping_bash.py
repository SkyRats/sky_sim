...
class Mapping():
    ...
    def save_pictures(self):
        ...
        name = "image%d.jpeg"%self.quantidade_fotos
        process = subprocess.Popen(['raspistill','-ss','2500','--nopreview','-o', name], stdout=subprocess.PIPE, text=True)
        ...
        self.add_gps_metadata("/home/ubuntu/image.jpeg",latitude, longitude)
